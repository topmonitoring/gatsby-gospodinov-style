...
const PreviewCoursesFetures = () => {
    ...
    <CourceCard>
      ...
      <span>✂️Класическо подстригване</span>
      <span>✂️Детско подстригване</span>
      <span>✂️Подстригване тип Fade</span>
      </FeatureContainer>
    </CourceCard>
    <CourceCard left>
    ...
    <VerticalLine/>
      ...
      <span>✂️Бръснене</span>
      <span>✂️Оформяне на брада</span>
      <span>✂️Кралско Бръснене</span>
      </FeatureContainer>
    </CourceCard>
    <CourceCard>
    ...
    <VerticalLine/>
      ...
      <span>✂️Оформяне на вежди</span>
      <span>✂️Кола маска уши/нос</span>
      <span>✂️Маска за лице</span>
      <span>✂️Измиване и изсушаване</span>
      <span>✂️Прилагане на висок клас продукти</span>
      </FeatureContainer>
    </CourceCard>
    </CourceGrid>
  )
